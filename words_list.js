...
const words_5 = { 
    "ample": { "en-meaning" : "(adj.) more than enough, large, spacious", "ko-meaning" : "풍부  충분한  넓은", "synonyms" : "", "antonym" : ""},
    "assert": { "en-meaning" : "(v.) to declare or state as truth, maintain or defend, put forward forcefully", "ko-meaning" : "주장하다  단언하다  강력히 주장하다", "synonyms" : "", "antonym" : ""},
    "disdain": { "en-meaning" : "(v.) to look upon with scorn; to refuse scornfully; (n.) a feeling of contempt", "ko-meaning" : "경멸하다  경멸  멸시하다", "synonyms" : "", "antonym" : ""},
    "ethical": { "en-meaning" : "(adj.) having to do with morals, values, right and wrong; in accordance with standards of right conduct; requiring a prescription for purchase", "ko-meaning" : "윤리의  도덕의", "synonyms" : "", "antonym" : ""},

    "inaudible": { "en-meaning" : "(adj.) not able to be heard", "ko-meaning" : "들리지 않는  알아들을 수 없는  들을 수 없는", "synonyms" : "", "antonym" : ""},
    "indiscriminate": { "en-meaning" : "(adj.) without restraint or control; unselective", "ko-meaning" : "무차별의  닥치는 대로의  분간 없는", "synonyms" : "", "antonym" : ""},
    "intrigue": { "en-meaning" : "(n.) crafty dealings, underhanded plotting; (v.) to form and carry out plots; to puzzle or excite the curiosity", "ko-meaning" : "음모를 꾸미다  끌다  호기심을 돋우다", "synonyms" : "", "antonym" : ""},
    "jurisdiction": { "en-meaning" : "(n.) an area of authority or control; the right to administer justice", "ko-meaning" : "사법권  관할권  권한", "synonyms" : "", "antonym" : ""},

    "plausible": { "en-meaning" : "(adj.) appearing true, reasonable, or fair", "ko-meaning" : "그럴듯한  정말 같은  외양만 좋은", "synonyms" : "", "antonym" : ""},
    "prodigal": { "en-meaning" : "(adj.) wastefully extravagant; lavishly or generously abundant; (n.) one who is wasteful and self-indulgent", "ko-meaning" : "낭비하는  방탕한  풍부한", "synonyms" : "", "antonym" : ""},
    "proximity": { "en-meaning" : "(n.) nearness, closeness", "ko-meaning" : "근접  가까움  접근", "synonyms" : "", "antonym" : ""},
    "volatile": { "en-meaning" : "(adj.) highly changeable, fickle; tending to become violent or explosive; changing readily from the liquid to the gaseous state", "ko-meaning" : "휘발성의  불안정한  휘발하는", "synonyms" : "", "antonym" : ""}
}

const words_6 = { 
    "aloof": { "en-meaning" : "(adj.) withdrawn, standing apart from others (usually as a matter of choice)", "ko-meaning" : "냉담한  초연한  떨어져서", "synonyms" : "", "antonym" : ""},
    "anguish": { "en-meaning" : "(n.) great mental suffering, distress, or pain; (v.) to be deeply tormented by pain or sorrow", "ko-meaning" : "고통  괴로워하다  비통  분노  고민", "synonyms" : "", "antonym" : ""},
    "articulate": { "en-meaning" : "(v.) to pronounce distinctly; to express well in words; to fit together into a system; (adj.) able to use language effectively; expressed clearly and forcefully", "ko-meaning" : "똑똑히 발음하다  체절 동물  음절로 나누다", "synonyms" : "", "antonym" : ""},
    "defect": { "en-meaning" : "(n.) an imperfection, flaw, or blemish of some kind; (v.) to desert a cause or organization", "ko-meaning" : "결함  장애  탈주  이탈", "synonyms" : "", "antonym" : ""},

    "forthright": { "en-meaning" : "(adj.) frank, direct, straightforward", "ko-meaning" : "솔직한  똑바른  똑바로 앞으로", "synonyms" : "", "antonym" : ""},
    "genial": { "en-meaning" : "(adj.) cordial, pleasantly cheerful or warm", "ko-meaning" : "친절한  온화한  따뜻한", "synonyms" : "", "antonym" : ""},
    "instill": { "en-meaning" : "(v.) to add gradually; to introduce or cause to be taken in", "ko-meaning" : "서서히 불어넣다  주입하다  주입시키다", "synonyms" : "", "antonym" : ""},
    "ostracize": { "en-meaning" : "(v.) to exclude from a group, banish, send away", "ko-meaning" : "~을 추방하다  배척하다  절교하다", "synonyms" : "", "antonym" : ""},

    "rehabilitate": { "en-meaning" : "(v.) to make over in good form; to restore to good condition or to a former position", "ko-meaning" : "명예를 회복시키다  사회로 복귀시키다  복직시키다", "synonyms" : "", "antonym" : ""},
    "resolute": { "en-meaning" : "(adj.) bold, determined; firm", "ko-meaning" : "단호한  결의에 찬  의지가 굳은", "synonyms" : "", "antonym" : ""},
    "retentive": { "en-meaning" : "(adj.) able to hold, keep, or recall; retaining knowledge easily", "ko-meaning" : "보유하는  기억력이 좋은  보존하는", "synonyms" : "", "antonym" : ""},
    "scapegoat": { "en-meaning" : "(n.) a person or thing carrying the blame for others", "ko-meaning" : "남의 죄를 대신 지는 사람  희생양  희생", "synonyms" : "", "antonym" : ""}
}

const words_7 = { 
    "acme": { "en-meaning" : "(n.) the highest point", "ko-meaning" : "절정  극치  전성기", "synonyms" : "", "antonym" : ""},
    "attribute": { "en-meaning" : "(n.) a quality or characteristic belonging to or associated with someone or something; (v.) to assign to, credit with; to regard as caused by or resulting from", "ko-meaning" : "특성  원인으로 여기다  ~로 여기다  ~에 따른", "synonyms" : "", "antonym" : ""},
    "belittle": { "en-meaning" : "(v.) to make something appear smaller than it is; to refer to in a way that suggests lack of importance or value", "ko-meaning" : "과소 평가하다  ~을 작게 하다  얕보다", "synonyms" : "", "antonym" : ""},
    "convey": { "en-meaning" : "(v.) to transport; to transmit; to communicate, make known; to transfer ownership or title to", "ko-meaning" : "전달하다  전하다  나타내다  의미하다", "synonyms" : "", "antonym" : ""},

    "doctrine": { "en-meaning" : "(n.) a belief, principle, or teaching; a system of such beliefs or principles; a formulation of such beliefs or principles", "ko-meaning" : "원칙  독트린", "synonyms" : "", "antonym" : ""},
    "exotic": { "en-meaning" : "(adj.) foreign; charmingly unfamiliar or strikingly unusual", "ko-meaning" : "이국적인  이국풍의  외국의", "synonyms" : "", "antonym" : ""},
    "juncture": { "en-meaning" : "(n.) a joining together; the point at which two things are joined; any important point in time", "ko-meaning" : "연결  접합  시점", "synonyms" : "", "antonym" : ""},
    "menial": { "en-meaning" : "(adj.) lowly, humble, lacking importance or dignity; (n.) a person who does the humble and unpleasant tasks", "ko-meaning" : "하인  머습  비천한", "synonyms" : "", "antonym" : ""},

    "predatory": { "en-meaning" : "(adj.) preying on, plundering, or piratical", "ko-meaning" : "약탈하는  생물을 잡아먹는  육식하는", "synonyms" : "", "antonym" : ""},
    "ravage": { "en-meaning" : "(v.) to destroy, lay waste, ruin; (n.) ruinous damage, destruction", "ko-meaning" : "황폐 파괴  ~을 약탈하다", "synonyms" : "", "antonym" : ""},
    "stance": { "en-meaning" : "(n.) a way of holding the body; an attitude or position on an issue", "ko-meaning" : "입장  자세  태도  전망  노선", "synonyms" : "", "antonym" : ""},
    "unassuming": { "en-meaning" : "(adj.) not putting on airs, unpretentious; modest", "ko-meaning" : "주제넘지 않는  젠체하지 않는  겸손한", "synonyms" : "", "antonym" : ""}
}
